...
def _make_plots(
    ...
    dcs_count, dcs_err = stats.counts(dcs_delta_m, np.ones_like(dcs_delta_m), bins)
    cf_count, cf_err = stats.counts(cf_delta_m, np.ones_like(cf_delta_m), bins)
    _plot_fit(
        dcs_count,
        cf_count,
        bins,
    ...
    dcs_count, dcs_err = stats.counts(dcs_delta_m, dcs_weights, bins)
    cf_count, cf_err = stats.counts(cf_delta_m, cf_weights, bins)
    _plot_fit(
        dcs_count,
        cf_count,
        bins,
