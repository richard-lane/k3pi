...
def ext_model_fixed_prompt(
    ...
    def ret_fcn(
        ...
        return (
            ...
            + n_bkg * norm_peak(pts, centre, width_l, width_r, alpha_l, alpha_r, beta),
        )
...
def fixed_prompt_unbinned_fit(
    ...
    fitter.limits["width_l"] = (0.5, None)
    fitter.limits["width_r"] = (0.5, 4.0)
...
def plot_fixed_prompt(
    ...
    predicted_bkg = (
        fit_params[1] * stats.areas(bins, norm_peak(bins, *fit_params[2:])) / bin_widths
    )
